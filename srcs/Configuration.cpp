...
Configuration::Configuration(ILogger &errorLogger) : 
...
const std::vector<IBlock *> Configuration::getBlocks(const std::string &parameter) const
{
    try{
        ...
        _errorLogger.errorLog(DEBUG, "Configuration::getBlocks: " + parameter + " not found");
    }
...
const std::vector<std::string> Configuration::getStringVector(const std::string &parameter) const
{
    try{
        ...
        _errorLogger.errorLog(DEBUG, "Configuration::getStringVector: " + parameter + " not found");
    }
...
const std::string Configuration::getString(const std::string &parameter) const
{
    try{
        ...
        _errorLogger.errorLog(DEBUG, "Configuration::getString: " + parameter + " not found");
    }
    return std::string();
}
...
int Configuration::getInt(const std::string &parameter) const
{
    try{
        ...
        _errorLogger.errorLog(DEBUG, "Configuration::getInt: " + parameter + " not found");
    }
    return -1;
}
...
size_t Configuration::getSize_t(const std::string &parameter) const
{
    try {
        ...
        _errorLogger.errorLog(DEBUG, "Configuration::getSize_t: " + parameter + " not found");
    }
    return -1;
}
...
bool Configuration::getBool(const std::string &parameter) const
{
    try {
        ...
        _errorLogger.errorLog(DEBUG, "Configuration::getBool: " + parameter + " not found");
    }
    return false;
}
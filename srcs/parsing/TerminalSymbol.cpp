...
TerminalSymbol::TerminalSymbol(std::string const value, int const id) : m_value(value),
																		m_id(id)
{
}
...
TerminalSymbolSet::TerminalSymbolSet(std::string const name, int id, std::vector<std::string> const values, ASymbolMatching &matching) : m_value(name),
																																		 m_id(id),
																																		 m_values(values),
																																		 m_matching(matching)
{

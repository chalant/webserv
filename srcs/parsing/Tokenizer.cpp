...
Token::Token(const std::string value, bool reserved) : value(value),
													   reserved(reserved)
{
}
...
Tokenizer::Tokenizer(const std::vector<std::string> separators, const std::vector<std::string> reserved_symbols) : m_separators(separators),

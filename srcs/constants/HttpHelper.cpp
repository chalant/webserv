...
{
    return this->m_method_helper.httpMethodStringMap(method);
}
...
{
    return this->m_version_helper.httpVersionStringMap(version);
}
...
{
    return this->m_header_helper.httpHeaderStringMap(header);
}
...
{
    return this->m_status_code_helper.httpStatusCodeStringMap(statusCode);
}
...
{
    return this->m_status_code_helper.stringHttpStatusCodeMap(statusCode);
}
...
{
    return this->m_status_code_helper.intHttpStatusCodeMap(statusCode);
}
...
{
    return this->m_status_code_helper.getStatusLine(statusCode);
}
...
{
    return this->m_status_code_helper.getHtmlPage(statusCode);
}

// Generate an HTML page with the specified HTTP status code
std::string HttpHelper::getErrorResponse(HttpStatusCode statusCode) const
{
    return this->m_status_code_helper.getErrorResponse(statusCode);
}

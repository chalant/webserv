...
LocationBlock::LocationBlock(ILogger &logger, const std::string name, Defaults defaults, bool is_regex):
	ConfigurationBlock(logger, name, defaults), m_is_regex(is_regex) {
}

LocationBlock::LocationBlock(const ConfigurationBlock &parent, const std::string name, Defaults defaults, bool is_regex):

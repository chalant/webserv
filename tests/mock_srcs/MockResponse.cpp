...
std::string MockResponse::getStatusLine() const
{
    return "";
}

std::string MockResponse::getHeaders() const
{
    return "";
}

std::string MockResponse::getBody() const
{
    return "";
}
...
void MockResponse::setErrorResponse(int statusCode)
{
    (void)statusCode;
}

// Set response fields from a complete response vector
void MockResponse::setResponse(std::vector<char> response)
{
    (void)response;
}

// Getters for specific parts of the response
std::string MockResponse::getStatusCodeString() const
{
    return "";
}

std::string MockResponse::getResponseSizeString() const
{
    return "";
}

size_t MockResponse::getResponseSize() const
{
    return 0;
}
...
std::vector<char> MockResponse::serialise()
{

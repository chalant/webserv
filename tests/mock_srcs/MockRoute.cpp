...
bool MockRoute::match(const std::string &value)
{
    (void)value;
    return false;
}
...
void MockRoute::setCgiScript(std::string &cgi_script)
{
    m_cgi_script = cgi_script;
}
...
void MockRoute::setResponseGenerator(IResponseGenerator *generator)
{

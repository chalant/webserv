...
/*
A Special class that takes in a IURIMatcher and provides a method for testing if
an URI matches the configuration block.
*/
...
public:
    LocationBlock(ILogger &logger, const std::string name, Defaults &defaults,
                  bool is_regex);
    LocationBlock(const ConfigurationBlock &parent, const std::string name,

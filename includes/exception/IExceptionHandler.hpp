 ...
 *
 * This file defines the ExceptionHandler interface, which serves as the abstract base
 * class for the ExceptionHandler in webserv. 
 * IExceptionHandler allows for polymorphic behavior and dependency injection,
 * thereby enabling us to create a MockExceptionHandler class for isolated unit testing.
 * 
 */
